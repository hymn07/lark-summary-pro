      ...
      config: [
        {
          ...
          scopes: ["auth:user.id:read", "offline_access", "minutes:minutes.search:read", "minutes:minutes:readonly", "minutes:minutes.transcript:export", "drive:drive", "docx:document", "vc:meeting.search:read"],
